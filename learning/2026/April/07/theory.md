...
In Week 1, to make predictions for 3 houses, we had to run our predict method 3 separate times. In Python, this requires a `for` loop, which is notoriously slow for large datasets.
