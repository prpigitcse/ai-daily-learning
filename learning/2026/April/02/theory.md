...
The entire goal of training a machine learning model is to adjust the weights and biases (which we built in [Day 4: Functions and Lines](/2026/february/25/functions-and-lines-adding-the-bias)) so that the Loss Function returns a number as close to zero as possible. 
